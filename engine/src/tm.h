...
void adjust_soft_limit(ThreadInfo &thread_info, uint64_t best_move_nodes, int bm_stability, int score) {
  score = abs(score);
  ...
  double eval_factor = (score > 75 && score < 125 ? 1.25 : score > 50 && score < 200 ? 1 : 0.75);
